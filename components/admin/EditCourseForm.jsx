...
function StepCourseInfo({ course, onChange, onNext }) {
  ...
  return (
    <div
      className="max-w-6xl mx-auto py-20 px-8 bg-white dark:bg-black"
  ...
  return (
    ...
    >
      <div className="mb-12">
        ...
        <div className="h-1 bg-red-600 w-32 mb-6" />
        <p className="font-bold text-2xl text-black dark:text-white tracking-wide">
          CRÉEZ ET MODIFIEZ DES LEÇONS STRUCTURÉES
        </p>
      </div>
  ...
  return (
    ...
    >
      <div className="mb-12">
        ...
        <div className="h-1 bg-red-600 w-32 mb-6" />
        <p className="font-bold text-2xl text-black dark:text-white tracking-wide">
          VÉRIFIEZ LES DÉTAILS AVANT MISE À JOUR
        </p>
      </div>
          ...
          {(course.imageFile || course.image) && (
            <div className="mt-6">
              ...
              <img
                src={
                  course.imageFile
                    ? URL.createObjectURL(course.imageFile)
                    : course.image
                }
                alt="Image du cours"
...
export default function EditCourseForm({ course: initialCourse }) {
