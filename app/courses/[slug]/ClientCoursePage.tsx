...
const LessonCard = ({
  ...
  return (
    <motion.div
      ...
      className="border-2 border-black dark:border-white bg-white dark:bg-neutral-950 p-2 sm:p-3 cursor-pointer transition-all duration-200 hover:border-red-600 hover:-translate-y-0.5 rounded"
      onClick={() =>
    ...
    <div className="max-w-4xl mx-auto min-h-screen  text-neutral-900 dark:text-neutral-100 py-32 px-4 sm:px-6">
      ...
      <header className="mb-6 sm:mb-8">
        ...
        <button
          onClick={() =>
            router.push(
              `/courses/${course.slug}/lessons/${course.lessons[0]?.slug}`
            )
          }
          className="px-3 py-1.5 bg-red-600 text-white font-black text-xs sm:text-sm tracking-wide border-2 border-black dark:border-white transition-all duration-200 hover:-translate-y-0.5 rounded"
